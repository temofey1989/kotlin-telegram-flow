 ...
 * [TelegramBotExecutionFailed] event and provides a way to define custom
 ...
 */
abstract class TelegramBotErrorHandler : EventListener<TelegramBotExecutionFailed> {
    override val supportedClass = TelegramBotExecutionFailed::class.java
}
